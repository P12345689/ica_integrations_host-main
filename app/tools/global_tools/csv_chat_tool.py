# -*- coding: utf-8 -*-
"""
CSV Chat tool for querying CSV data.

This module provides a tool that uses the CSV chat functionality from the main router.
"""
...
from app.routes.csv_chat.csv_chat_router import chat_with_csv # load_dataframe, process_csv_chat
...
@tool
@run_async_in_thread
async def csv_chat_tool(input_json: str) -> str:
    """
