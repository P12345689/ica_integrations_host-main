...
_TOOL_DEFINITIONS: Optional[List[Tool]] = None
...
def create_tools_from_definitions(tool_definitions: List[dict], context: Optional[dict] = None) -> List[Tool]:
    """
...
def get_tool_definitions(context: Optional[dict] = None) -> List[Tool]:
    """
    ...
    if (_TOOL_DEFINITIONS is None) or (context is not None):
        ...
        with open(json_file_path, "r") as f:
            ...
            _TOOL_DEFINITIONS = create_tools_from_definitions(json_data, context)

        logger.info(f"Loaded {len(_TOOL_DEFINITIONS)} tools:")
...
def get_tools(tool_names: Optional[List[str]] = None, context: Optional[dict] = None) -> List[Tool]:
    """
