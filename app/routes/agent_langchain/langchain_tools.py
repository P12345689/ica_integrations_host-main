'''
    To add the langchain tools follow the below steps:
        1. add in get_tools function
        2. add in tools descriptions
'''
...
def get_selected_tools(tool_names: Union[str, List[str]]) -> List[str]:
    ...
    return [tool for tool in ALL_TOOLS if tool.name in parsed_tool_names]
