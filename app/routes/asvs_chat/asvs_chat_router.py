# -*- coding: utf-8 -*-
"""
Author: Mihai Criveti, adapted by Matt Colman for ASVS
Description: ASVS Chat Integration Router
...
def add_custom_routes(app: FastAPI):
    @app.post("/experience/asvs_chat/ask/invoke")
    ...
    @app.post("/system/asvs_chat/info/invoke")
